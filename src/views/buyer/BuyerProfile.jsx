// src/views/buyer/BuyerProfile.jsx
...
const BuyerProfile = () => {
    ...
    const handleUpdate = () => {
        ...
        dispatch(updateBuyerProfile({ id, data: formData }))
            .unwrap()
            .then(() => {
    ...
    const handlePasswordReset = () => {
        ...
        setPasswordResetSeverity('error'); // reset severity

        dispatch(resetBuyerPassword({ oldPassword, newPassword }))
            .unwrap()
            .then((res) => {
                const message = res?.data?.data?.message || res?.data?.message || 'Reset failed';

                if (message.toLowerCase().includes('incorrect') || message.toLowerCase().includes('not match')) {
